...
class SCRFD:
    ...
    def prepare(self, ctx_id, **kwargs):
        ...
        if input_size is not None:
            if self.input_size is not None:
                print('warning: det_size is already set in scrfd .insightface, ignore')
            else:
    ...
    def forward(self, img, threshold):
        ...
        for idx, stride in enumerate(self._feat_stride_fpn):
            # If .insightface support batch dim, take first output
            if self.batched:
            ...
            # If .insightface doesn't support batching take output as is
            else:
                scores = net_outs[idx]
